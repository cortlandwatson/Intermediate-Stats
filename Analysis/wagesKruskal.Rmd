...
Five different Math 221 courses were given a brief start of semester survey. Two of the variables collected gave information about each student's class rank and their off-track hourly wage. How much do BYU-Idaho students make hourly during their off-track? Do they earn more as they gain more education?
...
ClassSurvey <- ClassSurvey[ClassSurvey$Wage<100,]
xyplot(Wage ~ Rank, data=ClassSurvey, type=c("p"))

# Filter out the missing Rank values:
ClassSurvey <- ClassSurvey[ClassSurvey$Rank %in% c("FR","JR","SO","SR"),]
xyplot(Wage ~ Rank, data=ClassSurvey, type=c("p"))
